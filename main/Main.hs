...
toFormatter Nixfmt{width, verify = True, pure_} = Nixfmt.formatVerify (layout width pure_)
toFormatter Nixfmt{width, verify = False, pure_} = Nixfmt.format (layout width pure_)
